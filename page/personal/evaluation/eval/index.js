  ...
  '自我认知能力': [
    {
      ...
      subItem: [
        {demention: '有战略思维和全局视角，凡事看大趋势，抓大放小', score: 0},
        {demention: '展现开放的思维，乐意接纳他人的意见', score: 0},
        {demention: '面对任务擅长考虑流程、细节，喜欢研究专业的、有深度的事物和内容', score: 0},
        {demention: '总是有创意的、有很多新点子的', score: 0}
      ]
    },
    {
      factor: '结果导向',
      ...
      subItem: [
        {demention: '做事严谨，仔细认真，特别注重过程和品质', score: 0},
        {demention: '凡事设立目标，擅长组织资源，克服困难达成目标', score: 0},
        {demention: '做事有计划、有步骤、有行动、有结果，是个靠谱的人', score: 0},
        {demention: '喜欢把控局面，控制事情的发展方向', score: 0}
      ]
    },
    {
      factor: '人际能力',
      ...
      subItem: [
        {demention: '懂得尊重他人，别人说话，从不打断', score: 0},
        {demention: '尝试并承担情感风险（引起他人的不悦情绪），甚至在充满焦虑和不确定的因素的时候', score: 0},
        {demention: '喜欢与他人分享自己的想法和感受', score: 0},
        {demention: '积极主动与他人沟通，喜欢表达', score: 0},
        {demention: '有高度的人际敏感度，关注他人感受', score: 0}
      ]
    },
    {
      factor: '个性特质',
      ...
      subItem: [
        {demention: '敢于为自己犯的错误承担责任', score: 0},
        {demention: '展现出对自我的觉察，有反思精神', score: 0},
        {demention: '展现出个人的正直品质，尊重事实，从不撒谎', score: 0},
        {demention: '对完成一项任务的兴趣远远大于与人打交道的兴趣', score: 0},
        {demention: '面对变化，能保持冷静，很快适应新的环境、要求和流程', score: 0}
      ]
    },
  ],
  '专业能力': [
    {
      ...
      subItem: [
        {demention: '对商业环境、市场需求敏锐，能够切实捕捉到市场机会', score: 0},
        {demention: '有经营意识，对任何机会的商务模式、资金流向有很清晰的生意逻辑', score: 0},
        {demention: '总能站在客户的角度思考产品或服务的可行性、体验感、接受度', score: 0},
        {demention: '当提出一个商业概念时，能够关注技术实现的可能性，了解技术的最新发展', score: 0}
      ]
    },
    {
      factor: '影响力',
      ...
      subItem: [
        {demention: '总能用使命感去感染他人，清晰的描绘愿景，用各种方法激励他人去实现愿景', score: 0},
        {demention: '有一颗谦卑的心，尊重他人、尊重事实、尊重环境', score: 0},
        {demention: '能以开放的胸怀接纳自己、包容他人，对人、对事表现出应有的格局', score: 0}
      ]
    },
    {
      factor: '目标导向',
      ...
      subItem: [
        {demention: '当接受一个任务时，总是能够根据计划、执行、检查和再行动的持续改进循环圈执行', score: 0},
        {demention: '做人做事从不食言，说话算数，言必行，行必果', score: 0},
        {demention: '承诺交付的任何工作、服务从不拖延，总能按质、按量、按时交付', score: 0}
      ]
    },
    {
      factor: '创新思维',
      ...
      subItem: [
        {demention: '总能用全局的视角去看待人、物、事，尝试用不同的组合、新颖的方法创造性的去解决问题', score: 0},
        {demention: '面对任务和挑战，不拘泥于过去的经验，而是总能从未来、更远的视角去思考可能性和解决方案', score: 0},
        {demention: '对任何工作的完成追求完美，总是不断的学习新方法和新技术，持续改进', score: 0}
      ]
    },
    {
      factor: '结构化能力',
      ...
      subItem: [
        {demention: '总是能把杂乱无章的信息或资料进行整理、分析和归类', score: 0},
        {demention: '思路清晰，习惯用结构化思维提出问题、分析问题和解决问题', score: 0},
        {demention: '经过洞察分析后，总能看到问题的核心并进行提炼总结', score: 0}
      ]
    },
    {
      factor: '团队协作',
      ...
      subItem: [
        {demention: '积极主动与他人连结，建立可以协作的伙伴关系', score: 0},
        {demention: '在团队合作中，总是以团队目标和利益为重，展现为团队成功作贡献', score: 0}
      ]
    }
  ]
};
